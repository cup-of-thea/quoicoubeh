...
<x-layout>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-4xl">
            <h2
                class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-powder"
            >
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div class="group relative max-w-xl">
                                ...
                                <p
                                    class="v mt-5 text-sm leading-6 text-gray-600"
                                >
                            ...
                            @if ($stream->featuring->count())
                                <div
                                    class="mt-6 flex border-t border-gray-900/10 pt-6 dark:border-gray-300/10"
                                >
                                    @php
                                        /** @var Member $member */
                                    @endphp
