<x-layout>
    <div class="px-6 py-32 lg:px-8">
        <div class="mx-auto max-w-3xl text-base leading-7 text-paynes-gray">
            <h1 class="mt-2 text-3xl font-bold tracking-tight text-black-pearl sm:text-4xl">
                {{ $post->title }}
            </h1>
            <div class="mt-4 flex items-center justify-between w-full text-xs">
